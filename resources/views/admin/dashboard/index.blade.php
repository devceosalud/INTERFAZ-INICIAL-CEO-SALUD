                            ...
                            <div class="media align-items-center">
                                <div class="media-body">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <h2 class="fs-40 font-w600 text-white mb-0 me-3">50000</h2>
                                        <div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <h2 class="fs-40 font-w600 text-white mb-0 me-3">6</h2>
                                        <div>
                                            <svg width="28" height="19" viewBox="0 0 28 19" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card gradient-bx text-white bg-info">
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body">
                                    <p class="mb-1">Citas</p>
                                    <div class="d-flex flex-wrap">
                                        <h2 class="fs-40 font-w600 text-white mb-0 me-3">150</h2>
                                        <div>
                                            <svg width="28" height="19" viewBox="0 0 28 19" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card gradient-bx text-white bg-secondary">
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body">
                                    <p class="mb-1">Ganancia del Dia</p>
                                    <div class="d-flex flex-wrap">
                                        <h2 class="fs-40 font-w600 text-white mb-0 me-3">5000</h2>
                                        <div>
                                            <svg width="28" height="19" viewBox="0 0 28 19" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="assigned-doctor owl-carousel">
                                <div class="items">
                                    <div class="text-center">
                                        ...
                                        <h5 class="fs-16 mb-1 font-w600"><a class='text-black' href='/page-review'>Dr. quiroz.</a></h5>
                                ...
                                <div class="items">
                                    <div class="text-center">
                                        ...
                                        <h5 class="fs-16 mb-1 font-w600"><a class='text-black' href='/page-review'>Dr. Calle</a></h5>
                                ...
                                <div class="items">
                                    <div class="text-center">
                                        ...
                                        <h5 class="fs-16 mb-1 font-w600"><a class='text-black' href='/page-review'>Dr. Sumaeta</a></h5>
                                ...
                                <div class="items">
                                    <div class="text-center">
                                        ...
                                        <h5 class="fs-16 mb-1 font-w600"><a class='text-black' href='/page-review'>Dra. Moreno</a></h5>
                                ...
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-panel flex-wrap">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-1"><a class='text-black' href='/patient-details'>JUan Arevalo</a></h5>
                                    ...
                                    <li>
                                        <div class="timeline-panel flex-wrap">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-1"><a class='text-black' href='/patient-details'>Hillary Rivera</a></h5>
                                    ...
                                    <li>
                                        <div class="timeline-panel flex-wrap">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-1"><a class='text-black' href='/patient-details'>Omar Meneses</a></h5>
                                    ...
                                    <li>
                                        <div class="timeline-panel flex-wrap">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-1"><a class='text-black' href='/patient-details'>Julia Porras</a></h5>
