...
window.addEventListener('DOMContentLoaded', () => {
    ...
    //VARIABLES GLOBALES QUE SE COMPARTE AL "calendario-medico.js" DESDE EL FORMULARIO DE FILTRO
    const specialty_id = document.querySelector('#filtro-calendar-medico_specialty_id');
    const doctor_id = document.querySelector('#filtro-calendar-medico_doctor_id');

    //EVENTO QUE ESPECIALIDAD SELECCIONA 
    specialty_id.addEventListener('change', function (event) {
        buscarEspecialidadFiltroCalendarioMedico(event);
    });
    ...
    doctor_id.addEventListener('change', function (event) {
        ...
        window.calendar_medico.refetchEvents();
    })
});
...
async function buscarEspecialidadFiltroCalendarioMedico(event) {
    ...
    try {
        ...
        const selectDoctor = document.querySelector('#filtro-calendar-medico_doctor_id');
        ...
        $('#filtro-calendar-medico_doctor_id').selectpicker('refresh');
